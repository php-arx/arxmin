...
@section('content')
<div id="container" ng-controller="formmanagerController as formmanager">
    <div class="row-fluid">
        <div class="span12">
            <div class="grid simple ">
                ...
                <div class="grid-body ">
                    ...
                    <table id="module-formmanager" class="display table datatable arx-table table-bordered table-hover table-condensed" cellspacing="0" width="100%">
                        <thead>
                        <tr>
                            <th></th>
...
@section('js')
<script data-main="<?php echo $theme_url; ?>/js/components/formmanager" src="<?php echo $theme_url; ?>/js/vendor/require.js"></script>
@stop
