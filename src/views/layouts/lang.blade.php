...
@section('head')
@parent
<link href="//cdnjs.cloudflare.com/ajax/libs/x-editable/1.4.5/bootstrap-editable/css/bootstrap-editable.css"
      rel="stylesheet"/>
@stop
...
@parent
<script
    src="//cdnjs.cloudflare.com/ajax/libs/x-editable/1.4.5/bootstrap-editable/js/bootstrap-editable.min.js"></script>
@stop
...
<div class="container arx-container">
    <div class="row">
        ...
        <div class="column col-sm-2 well arx-sidebar">
            <div class="affix">
                <h2>Lang Manager</h2>

                <p>{{ lg('arxmin::lang.title') }}</p>

                <ul class="nav">
                    <li>
                        <a href="#"><i class="icon-th-list"></i> All</a>
                    </li>
                    <li>
                        <a href="#"><i class="icon-th-list"></i> En</a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="panel-heading">
                            ...
                            <div class="btn-group">
                                ...
                                <button class="btn btn-link" type="button" data-toggle="collapse"
                                        data-target="#collapse1"><i class="icon-caret-down"></i> <i
                                        class="icon-caret-up"></i></button>
                            </div>
                        </div>
